                    ...
                    <div id="signup">
                        ...
                        <form method="post" action="{{ url('addCenomar') }}">
                            ...
                            <div class="field-wrap">
                                ...
                                <input name="birthdate" id="Birthdate" min="1960-12-31" max="2005-10-30"
                            ...
                            <div class="field-wrap">
                                <select name="purpose" id="Purpose of Request" required autocomplete="off">
                                    ...
                                    <option value="Passport / Tavel">Passport / Travel</option>
                            ...
                            <div class="verifyBtn">
                                <a href="{{ url('/verifyForm') }}"><button class="continueBtn">Submit</button></a>
                            </div>
                        </form>
                    </div>
                </div>
